...
if [[ ${PV} == *9999* ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/BlueSwordM/aom-av1-psy.git"
	EGIT_BRANCH="full_build-alpha-4"
...
HOMEPAGE="https://github.com/BlueSwordM/aom-av1-psy"
