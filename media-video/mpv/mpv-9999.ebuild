...
IUSE="
	...
	vaapi vdpau vapoursynth +vector vulkan wayland +xv zimg zlib"
REQUIRED_USE="
	${PYTHON_REQUIRED_USE}
	|| ( cli libmpv )
	egl? ( || ( X drm wayland ) )
...
src_configure() {
	...
	local emesonargs=(
		...
		$(meson_feature vapoursynth) # only available in overlays, luckily this is an overlay
